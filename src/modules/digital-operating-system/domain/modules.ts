...
export const cryptoFirstModules: DigitalModuleDefinition[] = [
  {
    ...
    href: "/origen-fondos",
    description: "Trazabilidad integrada de bancos, exchanges, wallets y documentación PDF o Excel.",
    primaryQuestion: "¿De dónde provienen los fondos y qué archivo tienes para respaldarlo?",
    examples: ["Fondos desde banco", "Operaciones desde exchange", "Fondos enviados a wallet", "Tengo PDF o Excel de respaldo"],
    status: "EMPTY",
  },
  {
    key: "cryptoAssets",
    label: "Activos",
    href: "/cryptoactivos",
    description: "Vista consolidada para revisar operaciones, saldos, activos detectados y datos pendientes.",
    primaryQuestion: "Revisa tus operaciones antes del análisis tributario",
    examples: ["Ver operaciones", "Revisar pendientes", "Activos detectados", "Eventos tributarios"],
    status: "PARTIAL",
  },
  {
    key: "taxObligations",
