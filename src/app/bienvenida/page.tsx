        ...
        <div style={{ maxWidth: "860px", margin: "0 auto" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "12px", marginBottom: "2rem" }}>
            {[
              ...
              <div key={item.stat} style={{ background: "rgba(22,163,74,0.06)", border: "1px solid rgba(22,163,74,0.15)", borderRadius: "14px", padding: "1.5rem", textAlign: "center" }}>
                <div style={{ fontFamily: "var(--font-display, 'Space Grotesk', sans-serif)", fontSize: "clamp(1.75rem, 3vw, 2.5rem)", fontWeight: 700, color: "#4ADE80", letterSpacing: "-0.02em", lineHeight: 1 }}>
                  {item.stat}
                </div>
                <div style={{ fontSize: "13px", color: "#94A3B8", marginTop: "6px" }}>{item.label}</div>
              </div>
            ))}
          </div>
          <div style={{ display: "flex", gap: "10px", justifyContent: "center", flexWrap: "wrap" }}>
            <Link href="/register" style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "12px 24px", borderRadius: "9px", background: "#16A34A", color: "#ffffff", fontSize: "14px", fontWeight: 700, textDecoration: "none" }}>
              Empezar gratis — 30 días
            </Link>
            <a href={WHATSAPP_URL} target="_blank" rel="noopener noreferrer" style={{ display: "inline-flex", alignItems: "center", gap: "8px", padding: "12px 24px", borderRadius: "9px", border: "1px solid rgba(255,255,255,0.1)", color: "#94A3B8", fontSize: "14px", fontWeight: 500, textDecoration: "none" }}>
