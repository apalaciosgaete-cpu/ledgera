...
async function readAnnulReason(request: NextRequest) {
  try {
    const body = (await request.json()) as AnnulMovementBody;
...
export async function PATCH(request: NextRequest, context: RouteContext) {
  ...
  try {
    ...
    const reason = await readAnnulReason(request);
    ...
    console.error("[api/movements/[id]/anular]", error);
