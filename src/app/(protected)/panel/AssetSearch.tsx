...
export function AssetSearch() {
  ...
  function handleSelect(asset: AssetResult) {
    ...
    setIsSuccess(false);
    setMessage("Activo seleccionado. Completa los datos manuales en el bloque inferior.");
  }
  ...
  async function saveManualBuy() {
    ...
    try {
      ...
      setIsSuccess(true);
      setMessage("Compra guardada correctamente. El consolidado se actualizará con este movimiento.");
      setQuantity("");
      setFeeUsd("0");
  ...
  return (
    <div style={{ marginBottom: "1.5rem" }}>
      <section style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 16, padding: "1rem 1.25rem", marginBottom: "0.85rem" }}>
        <div style={{ marginBottom: "1rem" }}>
          <h2 style={{ margin: "0 0 4px", color: "#0F2A3D", fontSize: "1rem", fontWeight: 800 }}>Buscar activo</h2>
          <p style={{ margin: 0, color: "#64748B", fontSize: "0.85rem" }}>Consulta CoinGecko para identificar el activo, su logo y su precio actual.</p>
        </div>
      ...
      <section style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 16, padding: "1rem 1.25rem" }}>
        <div style={{ marginBottom: "1rem" }}>
          <h2 style={{ margin: "0 0 4px", color: "#0F2A3D", fontSize: "1rem", fontWeight: 800 }}>Datos manuales de compra</h2>
          <p style={{ margin: 0, color: "#64748B", fontSize: "0.85rem" }}>Registra la compra para que LEDGERA actualice el consolidado desde un movimiento real.</p>
        </div>

        {!selected ? (
          <div style={{ background: "#F8FAFC", border: "1px dashed #CBD5E1", borderRadius: 12, padding: "1rem", color: "#64748B", fontSize: "0.875rem", fontWeight: 700 }}>
            Selecciona un activo en el buscador superior para completar los datos manuales.
          </div>
        ) : (
          <>
