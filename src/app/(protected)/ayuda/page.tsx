...
export default function AyudaPage() {
  return (
    <section style={{ maxWidth: 700, width: "100%" }}>
      <h1 style={{ color: "var(--text)", fontSize: "1.8rem", fontWeight: 850, lineHeight: 1.12, margin: "0 0 8px", fontFamily: fonts.display }}>
        Centro de Ayuda
      </h1>
      <p style={{ color: "var(--text-soft)", fontSize: 15, lineHeight: 1.6, margin: "0 0 32px" }}>
...
function HelpCard({ title, description }: { title: string; description: string }) {
  return (
    <div style={{
      ...
      <h3 style={{ color: "var(--text)", fontSize: 15, fontWeight: 800, margin: "0 0 6px", fontFamily: fonts.body }}>
        {title}
      </h3>
