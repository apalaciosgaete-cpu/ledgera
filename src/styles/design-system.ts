...
export const ui = {
  ...
  // ─── Botones ──────────────────────────────────────────────────────────────────
  buttonPrimary:
    "inline-flex items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-accent)] px-4 py-2 text-sm font-medium text-[var(--accent-contrast)] transition hover:bg-[var(--color-accent-hover)]",
  ...
  buttonDark:
    "inline-flex items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-primary)] px-4 py-2 text-sm font-medium text-[var(--accent-contrast)] transition hover:bg-[var(--color-primary-hover)]",

  buttonDanger:
    "inline-flex items-center justify-center rounded-[var(--radius-md)] bg-[var(--color-danger)] px-4 py-2 text-sm font-medium text-[var(--text)] transition hover:bg-[var(--color-danger-hover)]",
  ...
  tableHead:    "bg-[var(--color-primary)] text-left text-[var(--accent-contrast)]",
